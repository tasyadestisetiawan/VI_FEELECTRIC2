...
<div class="container my-5 py-5">
    <div class="row mt-4">
        <div class="col-md-6">
            {{-- CoffeBeans Image --}}
            <img src="{{ asset('storage/img/products/beans/' . $product->image) }}" class="img-fluid"
        ...
        <div class="col-md-6">
            ...
            <p class="text-muted">
                Rp {{ number_format($product->price, 0, ',', '.') }} / {{ $product->weight }}
            </p>
            <p>
                {{ $product->description }}
            </p>
...
<div class="container mt-4 mb-5">
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        <div class="col">
            <div class="card shadow-sm rounded pb-3 mb-3" style="border: solid 2px #3b2621">
                <div class="m-3">
                    <a href="{{ route('products.show', $recommendedProduct->id) }}">
                        <img src="{{ asset('storage/img/products/beans/' . $recommendedProduct->image) }}"
                            class="card-img-top object-fit cover" alt="{{ $recommendedProduct->name }}" height="300px"
                            width="300px" />
                    </a>
                </div>
