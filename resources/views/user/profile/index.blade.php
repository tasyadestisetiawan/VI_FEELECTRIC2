          ...
          <div class="card rounded-4 shadow-sm w-100" style="border: solid 1px #3b2621;">
            <div class="card-header bg-white border-0 mt-2">
              <ul class="nav nav-pills gap-3">
                <li class="nav-item">
                  <a class="nav-link active rounded-pill" style="background-color: #3b2621;  color: #fff7e8;" href="{{route('user.profile')}}">
                    Profile
                  </a>
                </li>
                <li class="nav-item">
            ...
            <div class="card-body mx-2">
              <div class="row">
                <!-- Image -->
                <div class="col-5">
                  <img src="https://i0.wp.com/www.cssscript.com/wp-content/uploads/2020/12/Customizable-SVG-Avatar-Generator-In-JavaScript-Avataaars.js.png?fit=438%2C408&ssl=1" class="img-fluid rounded-4" alt="..." style="width: 200px; border: solid 1px #3b2621;">
                </div>
                <!-- Biodata -->
                <div class="col-7">
                  <h5 class="card-title">
                  ...
                  <div class="mt-2">
                    <div class="row g-2">
                      ...
                      <div class="col-6">
                        <a href="{{ route('user.profile.edit') }}" class="btn" style="background-color: #3b2621; color: #fff;">
