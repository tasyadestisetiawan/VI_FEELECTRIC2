  ...
  <div class="row mt-4">
    ...
    <div class="col-md-7">
      <div class="alert alert-warning alert-dismissible rounded-4 fade show" role="alert"
        ...
        <button type="button" class="btn rounded-pill p-2 px-4 mb-3" data-bs-toggle="modal"
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-5 mb-3 text-center">
              <img src="{{ asset('storage/img/avatars/' . Auth::user()->avatar) }}"
                class="img-fluid rounded-4" alt="Profil" style="max-width: 200px; border: solid 3px #3b2621;">
            </div>
            <!-- Biodata -->
                ...
                <div class="row g-2">
                  <div class="col-6">
                    <form method="POST" action="{{ route('logout') }}">
                      @csrf
                      <button type="submit" class="btn btn-block" style="border-color: #3b2621; color: #3b2621;">
                  ...
                  <div class="col-6">
                    <a href="{{ route('user.profile.edit') }}" class="btn btn-block"
