...
@section('content')
    <div class="container my-5 py-5">
        <div class="header clearfix">
            ...
            <a href="{{ route('admin.coffee-machines.index') }}" class="btn btn-primary-theme btn-sm float-end mb-3">Back to Products</a>
            {{-- Edit Button --}}
            <a href="{{ route('admin.coffee-machines.edit', $product->id) }}" class="btn btn-edit-theme btn-sm float-end mb-3 me-3">Edit
                Product</a>
        </div>
        <div class="row">
            <div class="col-4">
